...
public class FileManagerActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        } else if (intent!=null && intent.getAction()!=null &&  intent.getAction().equals(ACTION_WIDGET)) {
...
//    	menu.add(0, MENU_SPACE, 0, "Free space").setIcon(R.drawable.space);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch(id) {
            case MENU_MKDIR:
                dialog.setContentView(R.layout.activity_file_manager_input_layout);
                    ...
                    public void onClick (View v) {
                        if (input.getText().length() > 1) {
                            if (mFileMag.createDir(mFileMag.getCurrentDir() + "/", input.getText().toString()) == 0)
                                ...
                                Toast.makeText(FileManagerActivity.this, "New folder was not created", Toast.LENGTH_SHORT).show();
                        }
                ...
                rename_create.setOnClickListener(new View.OnClickListener() {
                    public void onClick (View v) {
                        ...
                        if(mFileMag.renameTarget(mFileMag.getCurrentDir() +"/"+ mSelectedListItem, rename_input.getText().toString()) == 0) {
                            Toast.makeText(FileManagerActivity.this, mSelectedListItem + " was renamed to " +rename_input.getText().toString(),
                                    Toast.LENGTH_LONG).show();
                        }else
                            Toast.makeText(FileManagerActivity.this, mSelectedListItem + " was not renamed", Toast.LENGTH_LONG).show();
