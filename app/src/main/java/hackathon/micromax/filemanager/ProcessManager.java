...
public class ProcessManager extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_file_manager_manage_layout);
	...
	private class MyListAdapter extends ArrayAdapter<RunningAppProcessInfo> {
		...
		public MyListAdapter() {
			super(ProcessManager.this, R.layout.activity_file_manager_tablerow, display_process);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(view == null) {
				...
				view = inflater.inflate(R.layout.activity_file_manager_tablerow, parent, false);
			}
